...
public class BoardUtils { //klasa pomocnicza do planszy, ma zawierać tylko statyczne metody
    ...
    public static final String[] ALGEBRIC_NOTATION = initalizeAlgebraicNotation().toArray(new String[0]); // do wyświetlania logów
    ...
    private static List<String> initalizeAlgebraicNotation() {
